# MYFIT - Course Enrollment, Class Attendance & Coach Scheduling

## Overview

Hệ thống quản lý đăng ký khóa học, điểm danh lớp tập, và phân công ca cho HLV:
...
Coach có thể assign/unassign TRƯỚC khi ca kết thúc
Coach KHÔNG thể modify SAU shift.end_at

Ví dụ:
- Shift: 05:30 - 06:30
- Lúc 05:45: Có thể unassign ✅
- Lúc 06:35: Không thể unassign ❌ (SHIFT_ALREADY_ENDED)
```
...
# Test coach flow: login as coach@myfit.local / CoachPass123
